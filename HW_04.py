...
# in 9   out in the file  3*x^9 + 3*x^8 - 2*x^6 + 1*x^5 - 3*x^4 - 3*x^2 + 3 = 0
# in 5                    4*x^5 + 1*x^4 - 3*x^3 - 3 = 0
# in 3                    4*x^2 - 4 = 0

# in 0   out in the file  3*x^9 + 3*x^8 - 2*x^6 + 1*x^5 - 3*x^4 - 3*x^2 + 3 = 0           
# in -1                   4*x^5 + 1*x^4 - 3*x^3 - 3 = 0
# in 4                    4*x^2 - 4 = 0
